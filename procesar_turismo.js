...
const SERIES = {
  ...
  // ====== PROCEDENCIA NACIONAL (movilidad op.436, destino Peñíscola) — turistas por CCAA y provincia de origen ======
  TMOV1629059: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Andalucía', unidad: 'personas' },
  TMOV1629074: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Aragón', unidad: 'personas' },
  TMOV2246133: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Asturias, Principado de', unidad: 'personas' },
  TMOV1629089: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Balears, Illes', unidad: 'personas' },
  TMOV1629104: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Canarias', unidad: 'personas' },
  TMOV1680222: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Cantabria', unidad: 'personas' },
  TMOV1629148: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Castilla - La Mancha', unidad: 'personas' },
  TMOV1629134: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Castilla y León', unidad: 'personas' },
  TMOV1629162: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Cataluña', unidad: 'personas' },
  TMOV2492525: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Ceuta', unidad: 'personas' },
  TMOV1629177: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Comunitat Valenciana', unidad: 'personas' },
  TMOV1629192: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Extremadura', unidad: 'personas' },
  TMOV1629206: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Galicia', unidad: 'personas' },
  TMOV1629220: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Madrid, Comunidad de', unidad: 'personas' },
  TMOV2576899: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Melilla', unidad: 'personas' },
  TMOV1629235: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Murcia, Región de', unidad: 'personas' },
  TMOV1629250: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Navarra, Comunidad Foral de', unidad: 'personas' },
  TMOV1629266: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'País Vasco', unidad: 'personas' },
  TMOV1629281: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Rioja, La', unidad: 'personas' },
  TMOV2101184: { categoria: 'procedencia', metrica: 'turistas', residencia: 'ccaa', nombre: 'Total Nacional', unidad: 'personas' },
  TMOV1939274: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Albacete', unidad: 'personas' },
  TMOV1679751: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Alicante/Alacant', unidad: 'personas' },
  TMOV1964344: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Almería', unidad: 'personas' },
  TMOV1679724: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Araba/Álava', unidad: 'personas' },
  TMOV2282969: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Asturias', unidad: 'personas' },
  TMOV1679796: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Badajoz', unidad: 'personas' },
  TMOV1679825: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Barcelona', unidad: 'personas' },
  TMOV1680354: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Bizkaia', unidad: 'personas' },
  TMOV1961275: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Burgos', unidad: 'personas' },
  TMOV1963794: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Ciudad Real', unidad: 'personas' },
  TMOV1679915: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Coruña, A', unidad: 'personas' },
  TMOV1977289: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Cuenca', unidad: 'personas' },
  TMOV1679853: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Cáceres', unidad: 'personas' },
  TMOV2541562: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Cádiz', unidad: 'personas' },
  TMOV1952313: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Córdoba', unidad: 'personas' },
  TMOV1679987: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Gipuzkoa', unidad: 'personas' },
  TMOV1679944: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Girona', unidad: 'personas' },
  TMOV1941708: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Granada', unidad: 'personas' },
  TMOV1967890: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Guadalajara', unidad: 'personas' },
  TMOV2543527: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Huelva', unidad: 'personas' },
  TMOV1680018: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Huesca', unidad: 'personas' },
  TMOV2086168: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Jaén', unidad: 'personas' },
  TMOV1680047: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'León', unidad: 'personas' },
  TMOV1851463: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Lleida', unidad: 'personas' },
  TMOV1992500: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Lugo', unidad: 'personas' },
  TMOV1884789: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Madrid', unidad: 'personas' },
  TMOV1680134: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Murcia', unidad: 'personas' },
  TMOV1680120: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Málaga', unidad: 'personas' },
  TMOV1680150: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Navarra', unidad: 'personas' },
  TMOV2381741: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Ourense', unidad: 'personas' },
  TMOV1953035: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Palencia', unidad: 'personas' },
  TMOV1680180: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Palmas, Las', unidad: 'personas' },
  TMOV1680194: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Pontevedra', unidad: 'personas' },
  TMOV1680207: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Salamanca', unidad: 'personas' },
  TMOV2282984: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Santa Cruz de Tenerife', unidad: 'personas' },
  TMOV1988771: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Segovia', unidad: 'personas' },
  TMOV1680251: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Sevilla', unidad: 'personas' },
  TMOV1680266: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Soria', unidad: 'personas' },
  TMOV1914782: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Tarragona', unidad: 'personas' },
  TMOV1680296: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Teruel', unidad: 'personas' },
  TMOV1680310: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Toledo', unidad: 'personas' },
  TMOV1680325: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Valencia/València', unidad: 'personas' },
  TMOV1945076: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Valladolid', unidad: 'personas' },
  TMOV2004917: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Zamora', unidad: 'personas' },
  TMOV1902078: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Zaragoza', unidad: 'personas' },
  TMOV1679781: { categoria: 'procedencia', metrica: 'turistas', residencia: 'provincia', nombre: 'Ávila', unidad: 'personas' },
};
...
function organizarPorCategoria(seriesDescargadas) {
  const out = { hoteles: [], apartamentos: [], campings: [], padron: [], movilidad: [], procedencia: [] };
